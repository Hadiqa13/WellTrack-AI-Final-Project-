...
| Role | Responsibility |
|------|---------------|
| Backend Developer| Asma  | API development, database integration |
| Frontend Developer 1 | Aliya | UI development and API integration |
| Frontend Developer 2 | Eman| UI design, styling, UX |
| AI Engineer| Hadiqa | Gemini integration and AI features |
